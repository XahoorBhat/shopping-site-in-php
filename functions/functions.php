...
//etting the total price of the items from the cart
	  ...
	  $pro_image=$row_products['product_img1']; 
		...
		echo "
		 ...
		 <h3>$pro_title</h3>
		  ...
		  <img src='admin_area/product_images/$pro_image' width='auto' height='200'/><br>
...
while($row_cat_pro=mysqli_fetch_array($run_cat_pro)){
 ...
 $pro_desc=$row_cat_pro['product_description'];
